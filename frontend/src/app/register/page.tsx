    ...
    <main className="flex-1 flex flex-col items-center justify-center p-4 bg-[#f7f9fc] min-h-screen relative overflow-hidden font-sans">
      ...
      >
        ...
        <defs>
          ...
          <linearGradient id="paint0_linear_reg" x1="-50.9961" y1="-33.114" x2="-50.9961" y2="507.886" gradientUnits="userSpaceOnUse">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="bg-white/70 backdrop-blur-xl border border-white p-8 rounded-2xl shadow-xl shadow-indigo-500/2">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wide" htmlFor="name">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label className="block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wide" htmlFor="password">
                Password
              </label>
              <input
                id="password"
          ...
          <p className="text-center text-xs text-slate-500 mt-6 font-semibold">
            ...
            <Link href="/login" className="text-indigo-600 hover:text-indigo-500 font-extrabold transition-all">
              Sign In
            </Link>
          </p>
        </div>
